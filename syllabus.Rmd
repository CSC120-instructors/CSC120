...
All written communication regarding this course will take place via [Slack](https://slack.com) (a cloud-based communication platform that supports text, voice, and video). This includes:
...
- **DMs**: Message your professors directly for matters that require individual communication. Be sure to message *both* of us!

We (professors) will do our best to answer Slack messages promptly. Please note that messages sent outside of regular working hours (M-F 9:00AM - 5:00PM ET) will take us longer to respond to.

Messages sent via email will likely go unanswered. Please use Slack to help us stay organized. 
...
Weekly programming assignments will be introduced in class weekly, and we will work together to get started on them during class time. Final submissions will be due one week later at 11:59PM EST. Because our lives and learning do not always go as planned, every student will be able grant themselves extensions on homework assignments. Read details on [how to request an extension here](late-policy.html).

Our primary goal in this course is learning. False starts and mistakes are normal and expected! Because of this, you are allowed to revise and resubmit any assignment as many times as needed until the end of finals period (extensions beyond the end of finals require permission of the class dean). Please use revise and resubmit as an opportunity to improve your learning; carefully consider whether resubmitting for minimal points back will help you gain a deeper understanding of material. The highest grade will always be the one applied to your final grade, even if that is not the most recent submission. Revised and resubmitted assignments should be submitted on Gradescope the same way the original assignment was submitted. *Resubmitted assignments must include a change log explaining what changes were made from the previous submission. Resubmissions missing a changelog will not be graded.* 

<hr>
## Collaboration and Academic Integrity
Programming is more fun in groups!  Students are strongly encouraged to form study groups and to collaborate in solving the assignments -- you may submit your assignments as a group. Please ensure that all work you submit is ultimately the product of your own understanding rather than anyone else's.  You may consult online or print references on all assignments and labs. Standard language references showing syntax, usage, documentation, etc. need not be cited; nor does the course textbook.  All other resources must be cited as described below.
...
1. **Attribution:** We'll treat AI code-completion tools as "collaborators" in this class. Whenever you get help with your programming tasks, it is crucial to provide clear and transparent attribution. Include a comment or annotation in your code specifying that certain sections were generated with the help of an AI code-completion tool. *Proper attribution includes submitting a PDF copy of your entire AI transcript.*
